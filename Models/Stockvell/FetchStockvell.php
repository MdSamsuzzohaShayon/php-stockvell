...
class FetchStockvell extends Stockvell
{
    ...
    public function getASingleApprovedStockvellWithMembers($stockvell_id)
    {
        ...
        $stockvell_sql = "SELECT sm.id, sm.stockvell_id, s.agreement, s.description, s.goal, s.leader_id, s.category, s.payment, s.payment_frequency, s.withdraw_frequency, s.name, s.status,
