<div class="container">
  ...
  <div class="mobile-menu d-none d-md-none" id="mobile-expand-menu">
    <ul class="d-flex flex-column align-items-end">
      ...
      <li class="my-2 list-group-item">  <a href="#" class="nav-link text-secondary">Login</a> </li>
      <li class="my-2 list-group-item">  <a href="#" class="btn btn-outline-secondary">Signup</a> </li>
    <?php }?>
    </ul>
  </div>
</div>
